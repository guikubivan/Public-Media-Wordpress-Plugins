This littel plugin adds a playlist functionability to posts and pages.  A table is created that keeps tracks of your playlists, this is the SQL query that creates the table:
