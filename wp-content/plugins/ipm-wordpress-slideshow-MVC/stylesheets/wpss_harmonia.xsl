...
<xsl:template match="/photo">
		...
		<xsl:if test="url">
			<![CDATA[<div class="article-photo"><img class="postimage" src="]]><xsl:value-of select="large_url"/> <![CDATA[" alt="]]>
        ...
        <xsl:if test="caption">
			<![CDATA[<p class="photo-caption">]]><xsl:value-of select="caption"/><![CDATA[</p></div><!--end article-photo-->]]>
		</xsl:if>
