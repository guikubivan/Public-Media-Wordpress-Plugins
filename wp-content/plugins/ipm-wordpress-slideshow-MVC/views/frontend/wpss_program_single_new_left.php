...
?>
<div style="float:left; overflow:hidden; width:360px; height:240px;" class="program-slideshow">
...
else if($type == "photo")
{
	?>
		<? if(!empty($photo->url)) { ?>
			<div style="float:left; overflow:hidden;" class="postimage-wrapper"><div class="the-image-wrapper"><img style="width:360px; height:240px;" class="postimage" src="<?php echo $photo->large_url?>" alt="<?php echo $photo->alt?>" /></div>
		<? } ?>
