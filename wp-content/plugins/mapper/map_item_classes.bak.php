...
class postLocation extends map_item{
	...
	public function mapper_box(){
		add_meta_box('mapper-div', __('Location Mapper', 'mapperbox'), array(&$this, 'post_form'), 'post', 'normal', 'high');
		add_meta_box('mapper-div', __('Location Mapper', 'mapperbox'), array(&$this, 'post_form'), 'page', 'normal', 'high');
	}
	...
	public function editForm(){
		...
		<table>
			<tr>
				...
				<td rowspan='4'><div id="map" style="width: 400px; height: 250px"></div></td>
			</tr>
			<tr>
				<td>Latitude:</td><td><input type='text' id='latitude' name='latitude' value='<?php echo $this->latitude ? $this->latitude : '';; ?>'  /></td>
			</tr>
			<tr>
				<td>Longitude:</td><td><input type='text' id='longitude' name='longitude' value='<?php echo $this->longitude ? $this->longitude : '';; ?>'  /></td>
			</tr>
			<tr>
