...
switch (attribute_escape($_POST['post_action'])) {
	...
	case 'save_post_type':
		...
		if ($ok) {
			...
			$fields = array('name', 'user_level', 'category', 'based_on', 'template',
 			...
 			<tr>
 				...
 				<td>
					<select name="user_level">
						<?php $ul = $pages[$id]['user_level']; ?>
						<option value=""></option>
						<option value="10" <?php if ($ul == '10') echo 'selected="selected"'; ?>><?php _e('Administrator'); ?></option>
						<option value="7" <?php if ($ul == '7') echo 'selected="selected"'; ?>><?php _e('Editor'); ?></option>
						<option value="2" <?php if ($ul == '2') echo 'selected="selected"'; ?>><?php _e('Author'); ?></option>
						<option value="1" <?php if ($ul == '1') echo 'selected="selected"'; ?>><?php _e('Contributor'); ?></option>
					</select> <?php _e('The minimum user level required to edit this post type', 'more-fields'); ?>
 				</td>
 			</tr>	
			<?php endif; ?> 				
			<tr>
